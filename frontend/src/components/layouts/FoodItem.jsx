...
import { addItemToCart, removeItemsFromCart, updateCartQuantity } from '../../actions/cartAction';
...
export default function FoodItem({fooditem, restaurant}) {
    ...
    }, [cartItems, fooditem, setQuantity]);
    ...
    const decreaseQty = () => {
        if(quantity > 1) {
            ...
            setQuantity(0);
            setShowButtons(false);
            dispatch(removeItemsFromCart(fooditem._id));
        }
    };
    ...
    <div className="col-sm-12 col-md-6 col-lg-3 my-3">
        <div className="card p-3 rounded">
            ...
            <div className="card-body d-flex flex-column">
                ...
                <br/>
                <p>
                    Status: <span id="stock_status" className={fooditem.stock ? "greenColor" : "redColor"}>
                        {
